...
const Hero = () => {
  return (
    <div
    className="relative w-full flex md:items-end 2xs:bg-[20%] xs:items-center  bg-center bg-cover z-0 min-h-[170vh] 2xs:min-h-[160vh] xl:min-h-[130vh] bg-no-repeat overflow-hidden xl:bg-top"
